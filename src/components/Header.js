  ...
  return (
    <header className="stick top-0 z-50">
      ...
      <div className="flex items-center bg-amazon_blue p-1 flex-grow py-2">
        ...
        {/* hidden */}
        <div
          className=" sm:flex items-center h-10 rounded-md flex-grow cursor-pointer
        bg-yellow-400 hover:bg-yellow-500 "
        >
          <input
            className="p-2 h-full w-5 flex-grow flex-shrink rounded-l-md focus:outline-none
            px-4"
            type="text"
          />
        ...
        <div className="text-white flex items-center text-xs space-x-6 mx-6 whitespace-normal">
          ...
          >
            ...
            <span
              className="absolute top-0 right-0 md:right-10 w-4 h-4
